...
function updateTime() {
 ...
 // constantly updates the time and current day
    $("#currentDay").text(today.format("dddd, MMMM Do YYYY, h:mm.ss"));

// gives the color when the event is in the past, present or future
...
// helps store stuff in the local storage
...
// after clicking buttons it saves the wanted event
